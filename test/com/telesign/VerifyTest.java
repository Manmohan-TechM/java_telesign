...
public class VerifyTest {
	...
	public void verifyRequestCallWithCallForwardAction() {
		...
		VerifyResponse ret = ver.call(PHONE_NUMBER, "en-US", CALL_FORWARD_ACTION, ORIGINATING_IP, SESSION_ID);		
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
	...
	public void verifyRequestCallWithAllParams() {
		...
		VerifyResponse ret = ver.call(PHONE_NUMBER, "en-US", "12345", "keypress", 1, "1234", true, CALL_FORWARD_ACTION, ORIGINATING_IP, SESSION_ID);
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
	...
	public void verifyRequestPush(){
		...
		//VerifyResponse ret = ver.push(PHONE_NUMBER,"TS2FA");
		VerifyResponse ret = ver.push(PHONE_NUMBER,BUNDLE_ID);
		System.out.println("verifyRequestPush response: " + ret.toString()); // To Be removed
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
	...
	public void verifyRequestPushWithAllParams(){
		...
		VerifyResponse ret = ver.push(PHONE_NUMBER, PUSH_NOTIFICATION_TYPE, PUSH_NOTIFICATION_VALUE, BUNDLE_ID, "Why so sad", ORIGINATING_IP, SESSION_ID);
		System.out.println("verifyRequestPushWithAllParams response: " + ret.toString()); // To Be removed
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
	...
	public void verifyRequestSoftToken(){
		...
		VerifyResponse ret = ver.softToken(PHONE_NUMBER, SOFT_TOKEN_ID, "665125", BUNDLE_ID);
		System.out.println("verifyRequestSoftToken response: " + ret.toString()); // To Be removed
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
	...
	public void verifyRequestSoftTokenWithAllParams(){
		...
		if(!timeouts)
			...
			ver = new Verify(CUSTOMER_ID, SECRET_KEY, connectTimeout, readTimeout);
		//VerifyResponse ret = ver.softToken(PHONE_NUMBER, SOFT_TOKEN_ID, "414941", ORIGINATING_IP, SESSION_ID) ;
		VerifyResponse ret = ver.softToken(PHONE_NUMBER, SOFT_TOKEN_ID, "897135", BUNDLE_ID, ORIGINATING_IP, SESSION_ID);
	...
	public void vertifyRequestRegistration(){
		...
		System.out.println("verifyRequestRegistration response: " + ret.toString()); // To Be removed
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
	...
	public void verifyRequestRegistrationWithAllParams(){
		...
		System.out.println("verifyRequestRegistrationWithAllParams response: " + ret.toString()); // To Be removed
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
	...
	public void smartVerify(){
		...
		VerifyResponse ret = ver.smartVerify(PHONE_NUMBER,"BACS");
		System.out.println(ret.toString()); // To Be removed
		assertNotNull(ret);
		assertTrue(ret.errors.length == 0);
	}
